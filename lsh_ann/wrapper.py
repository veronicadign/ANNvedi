import numpy as np
# Historical name: this wrapper was written against the pre-rename module
# `lsh_cpp_module`, which is today built as `lsh_cpp_optimized` (same class
# name `LSHIndex`, same fit/query/profile API). Restored from git (commit
# 9988822~1) so the root Algorithm facade and the sweep scripts in
# experiments/ work again.
import lsh_cpp_optimized as lsh_cpp_module
