...
class LSHIndexSimple {
public:
    LSHIndexSimple() = default;
...
PYBIND11_MODULE(lsh_cpp_simple, m) {
    py::class_<LSHIndexSimple>(m, "LSHIndex")
        .def(py::init<>())
        .def("fit", &LSHIndexSimple::fit, py::arg("data"), py::arg("n_tables"), py::arg("n_bits"))
        .def("query", &LSHIndexSimple::query, py::arg("query"), py::arg("k"), py::arg("n_probes") = 0, py::arg("n_probe_clusters") = 8, py::arg("refine_r") = -1)
        .def("total_distances_count", &LSHIndexSimple::total_distances_count)
        .def("reset_distances_count", &LSHIndexSimple::reset_distances_count);
}
